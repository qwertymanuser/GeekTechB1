...
# cities = ["Tokmok", "Osh", "Bishkek", "Kant", "Ozgon", "Moskva", "London", "Rap", "Toyota", "Ferrari", "Classic", "Lamborgini", "Naryn", "Talas", "Chui" ]
# print(cities[2:8])

#2 Задача
#Создайте вручную список из чисел и выведите их в обратном порядке
# numbers = [15, 20, 30, 40, 55, 60, 75, 80, 90]
# print(numbers[::-1])
...
# a = sum(numbers)
# b = len(numbers)
# print("Среднее арифмитическое число: ", a/b)
